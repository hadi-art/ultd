...
{{--        integrity="sha384-Gn5384xqQ1aoWXA+058RXPxPg6fy4IWvTNh0E263XmFcJlSAwiGgFAW/dAiS6JXm"--}}
  ...
  <link rel="stylesheet" type="text/css" href="{{asset('bootstrap/css/dataTables.bootstrap4.min.css')}}">
  <style>
    body {
      padding: 25px;
    }
...
<script src="{{asset('bootstrap/js/jquery-3.2.1.slim.min.js')}}"
        crossorigin="anonymous"></script>
<script src="{{asset('bootstrap/js/bootstrap.min.js')}}"
{{--        integrity="sha384-JZR6Spejh4U02d8jOt6vLEHfe/JQGiRRSQQxSfFWpi1MquVdAyjUar5+76PVCmYl"--}}
        crossorigin="anonymous"></script>
<!-- FontAwesome -->
<script defer src="{{asset('bootstrap/js/all.js')}}"></script>
<!-- Datatables -->
<script type="text/javascript" src="{{asset('bootstrap/js/jquery.dataTables.min.js')}}"></script>
<script type="text/javascript" src="{{asset('bootstrap/js/dataTables.bootstrap4.min.js')}}"></script>
